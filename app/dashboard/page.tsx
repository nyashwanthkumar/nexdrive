...
export default function DashboardPage() {
  ...
  function FileIcon({ type }: { type: string }) {
    if (type === "image") {
      return <ImageIcon className="h-10 w-10 text-sky-600" />;
    }
    ...
    return <Folder className="h-10 w-10 text-zinc-500" />;
  }

  return (
    <main className="min-h-[calc(100vh-72px)] bg-[#f8fafd]">
      <div className="grid min-h-[calc(100vh-72px)] grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside className="border-r border-zinc-200 bg-[#f8fafd] px-5 py-6">
          <div className="mb-6">
            <UploadButton />
          </div>
        ...
        <section className="px-4 py-4 md:px-6">
          <div className="mb-4 flex items-center gap-3 rounded-2xl bg-[#edf2fc] px-4 py-3">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            <div className="mb-8">
              <h1 className="text-4xl font-normal text-zinc-900">
            ...
            {!isLoading && displayedFiles.length > 0 && (
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                {displayedFiles.map((file) => (
                  <div
                    key={file._id}
                    className="overflow-hidden rounded-2xl border border-zinc-200 bg-[#f8fafd]"
                  >
...
function SidebarItem({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex w-full items-center gap-3 rounded-r-full px-4 py-3 text-left text-base ${
        active
